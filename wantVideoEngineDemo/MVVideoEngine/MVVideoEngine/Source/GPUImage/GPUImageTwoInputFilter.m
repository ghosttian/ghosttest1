...
{
//	NSLog(@"%@ GPUImageTwoInputFilter %@ textureIndex %ld",self,NSStringFromCGSize(newSize),(long)textureIndex);
    if (textureIndex == 0)
    {
		...
		if (hasReceivedFirstFrame && newSize.width == 0) {
//			NSLog(@"%@ ERROR GPUImageTwoInputFilter %@ textureIndex %ld",self,NSStringFromCGSize(newSize),(long)textureIndex);
		}
    }
}
...
//	NSLog(@"%@ newFrameReadyAtTime atIndex %ld",self,(long)textureIndex);
...
//Fixbug !!! hasSetFirstTexture == YES;
    // || (hasReceivedFirstFrame && secondFrameCheckDisabled) || (hasReceivedSecondFrame && firstFrameCheckDisabled)
    if ((hasReceivedFirstFrame && hasReceivedSecondFrame && hasSetFirstTexture) || updatedMovieFrameOppositeStillImage)
    {
