//
//  MVVideoEffectRadialBlurPartialFilterExcutor.m
//  MVVideoEngine
//
...
@implementation MVVideoEffectRadialBlurPartialAnimationData

@end

@interface MVVideoEffectRadialBlurPartialFilterExcutor ()

@property(nonatomic,strong) MVVideoRadialBlurPartialFilter *radialBlurFilter;
@property(nonatomic,strong) NSArray *formatedAnimationPath;

@end

@implementation MVVideoEffectRadialBlurPartialFilterExcutor
...
- (NSArray *)formatedAnimationPath
{
    if (!_formatedAnimationPath) {
        ...
        for (NSDictionary *item in self.animationPath) {
            ...
            MVVideoEffectRadialBlurPartialAnimationData *animationData = [[MVVideoEffectRadialBlurPartialAnimationData alloc] init];
...
{
    return [MVVideoRadialBlurPartialFilter class];
}
...
- (GPUImageFilter *)getFilter
{
    ...
    self.radialBlurFilter = (MVVideoRadialBlurPartialFilter *)filter;
...
- (void)updateExcutorTime:(CFTimeInterval)time
{
    if (self.formatedAnimationPath.count > 0) {
        ...
        MVVideoEffectRadialBlurPartialAnimationData *startAnimationData = nil;
        MVVideoEffectRadialBlurPartialAnimationData *endAnimationData = nil;
