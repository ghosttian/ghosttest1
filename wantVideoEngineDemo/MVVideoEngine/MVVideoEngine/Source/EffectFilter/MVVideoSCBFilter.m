...
@implementation MVVideoSCBFilter

NSString *const KMVVideoSCBFilterFragmentShaderString = SHADER_STRING
(
...
- (instancetype)init
{
    self = [super initWithFragmentShaderFromString:KMVVideoSCBFilterFragmentShaderString];
    if (self) {
    }
    return self;
}
