//
//  MVVideoAdvancedCurveRGBFilter.m
//  microChannel
//
...
@implementation MVVideoAdvancedCurveRGBFilter

NSString *const kMVVideoAdvancedCurveRGBFilterFragmentShaderString = SHADER_STRING
(
...
{
    self = [super initWithFragmentShaderFromString:kMVVideoAdvancedCurveRGBFilterFragmentShaderString];
    if (self) {
        _curveImage = image;
    }
    return self;
