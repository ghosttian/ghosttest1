...
@implementation MVVideoCrayonPencilFilter

static NSString *const KMVVideoCrayonPencilFilterFragmentShaderString = SHADER_STRING
(
 ...
 void main()
 {
     ...
     gl_FragColor = vec4(yiq2rgb*yiq.rgb,1.0);
 }
...
- (instancetype)init
{
    self = [super initWithFragmentShaderFromString:KMVVideoCrayonPencilFilterFragmentShaderString];
    if (self) {
