...
@implementation MVVideoSketchFilter

NSString *const kMVVideoSketchFragmentShaderString = SHADER_STRING
(
...
{
    self = [super initWithFragmentShaderFromString:kMVVideoSketchFragmentShaderString];
    if (self) {
        [self setSketchImage:image];
